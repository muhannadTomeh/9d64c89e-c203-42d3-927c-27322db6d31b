...
const OilTrading: React.FC = () => {
  const { oilTrades, addOilTrade, getStatistics } = useMillContext();
  ...
  const sortedTrades = [...oilTrades].sort((a, b) => 
            ...
            <Tabs defaultValue="all">
                  ...
                  <div className="space-y-4 max-h-[400px] overflow-y-auto">
                    {sortedTrades.map((trade) => (
                      <Card key={trade.id} className={`border ${
                        trade.type === 'sell' ? 'border-green-200' : 'border-blue-200'
                      }`}>
                ...
                {sellTrades.length === 0 ? (
                  ...
                  <div className="space-y-4 max-h-[400px] overflow-y-auto">
                    {sellTrades.map((trade) => (
                      <Card key={trade.id} className="border border-green-200">
                        <CardContent className="p-4">
                          <div className="flex justify-between items-center mb-2">
              ...
              <TabsContent value="buy" className="p-4">
                {buyTrades.length === 0 ? (
                  ...
                  <div className="space-y-4 max-h-[400px] overflow-y-auto">
                    {buyTrades.map((trade) => (
                      <Card key={trade.id} className="border border-blue-200">
                        <CardContent className="p-4">
                          <div className="flex justify-between items-center mb-2">
